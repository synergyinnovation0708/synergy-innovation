...
const triggerClassName =
  "group inline-flex h-[50px] w-[200px] items-center justify-between rounded-[25px] bg-[#1d223f] pl-[26px] pr-[4px] text-[20px] font-semibold leading-[1.2] text-white transition-transform duration-200 hover:-translate-y-0.5";
...
export const ITServicesInquiryTrigger = ({
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div
          className="fixed inset-0 z-[120] flex items-center justify-center bg-[#1d223f]/58 px-4 py-6 backdrop-blur-[6px] sm:px-6"
          onClick={closeModal}
        >
          <div
            className="relative w-full max-w-[980px] overflow-hidden rounded-[28px] bg-white px-5 py-14 shadow-[0_32px_90px_rgba(29,34,63,0.3)] sm:px-8 lg:px-[56px] lg:py-[64px]"
            ...
            <div className="max-w-[820px]">
              ...
              <form className="mt-9" onSubmit={handleSubmit}>
                ...
                <p className="mt-4 text-[16px] font-medium leading-[1.4] text-[#9c9c9c] sm:text-[18px]">
                  Share your details and our IT team will reach out within 24
                  hours.
                </p>
